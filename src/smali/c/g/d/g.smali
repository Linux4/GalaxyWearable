...
.method public b(Landroid/content/Context;Landroidx/core/content/d/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lc/g/d/e;->b(Landroid/content/Context;Landroidx/core/content/d/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;[Lc/g/i/f$b;I)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-virtual {p0, p3, p4}, Lc/g/d/j;->h([Lc/g/i/f$b;I)Lc/g/i/f$b;
    ...
    :try_start_0
    invoke-virtual {p3}, Lc/g/i/f$b;->d()Landroid/net/Uri;
    ...
    invoke-virtual {p3}, Lc/g/i/f$b;->e()I
    ...
    invoke-virtual {p3}, Lc/g/i/f$b;->f()Z
    ...
    :cond_3
    invoke-static {p1, p3, p2}, Lc/g/d/k;->h(Landroid/content/Context;[Lc/g/i/f$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lc/g/i/f$b;->d()Landroid/net/Uri;
    ...
    :cond_5
    invoke-virtual {v4}, Lc/g/i/f$b;->c()I

    move-result v6

    invoke-virtual {v4}, Lc/g/i/f$b;->e()I

    move-result v7

    invoke-virtual {v4}, Lc/g/i/f$b;->f()Z
