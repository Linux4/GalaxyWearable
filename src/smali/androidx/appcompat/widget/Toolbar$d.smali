...
.method public f(Landroid/content/Context;Landroidx/appcompat/view/menu/f;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->e:Landroidx/appcompat/view/menu/f;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/h;
    ...
    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->e:Landroidx/appcompat/view/menu/f;
...
.method public i(Landroidx/appcompat/view/menu/f;Landroidx/appcompat/view/menu/h;)Z
    ...
    instance-of v0, p1, Lc/a/q/c;

    if-eqz v0, :cond_0

    check-cast p1, Lc/a/q/c;

    invoke-interface {p1}, Lc/a/q/c;->f()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/h;
...
.method public j(Landroidx/appcompat/view/menu/f;Landroidx/appcompat/view/menu/h;)Z
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/h;
    ...
    instance-of v0, p2, Lc/a/q/c;

    if-eqz v0, :cond_4

    check-cast p2, Lc/a/q/c;

    invoke-interface {p2}, Lc/a/q/c;->c()V
...
.method public n(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/h;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->e:Landroidx/appcompat/view/menu/f;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/f;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->i(Landroidx/appcompat/view/menu/f;Landroidx/appcompat/view/menu/h;)Z
