...
.field private k:Landroidx/appcompat/widget/AppCompatSpinner$f;
...
.field p:Landroidx/appcompat/widget/ListPopupWindow;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    iput v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->o:I

    invoke-virtual {p0}, Landroid/widget/Spinner;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-static {p0, v1}, Landroidx/appcompat/widget/z;->a(Landroid/view/View;Landroid/content/Context;)V

    sget-object v1, Lc/a/j;->Spinner:[I

    invoke-static {p1, p2, v1, p3, v0}, Landroidx/appcompat/widget/e0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/e0;
    ...
    invoke-direct {v2, p1, p5}, Lc/a/q/d;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {v1, p5, v0}, Landroidx/appcompat/widget/e0;->n(II)I
    ...
    invoke-direct {v2, p1, p5}, Lc/a/q/d;-><init>(Landroid/content/Context;I)V
    ...
    invoke-static {v3, p2, v4, p3, v0}, Landroidx/appcompat/widget/e0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/e0;
    ...
    invoke-virtual {v0, v3, v4}, Landroidx/appcompat/widget/e0;->m(II)I

    move-result v3

    iput v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->l:I

    invoke-virtual {p4}, Landroidx/appcompat/widget/ListPopupWindow;->e()I
    ...
    iput-object p4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/AppCompatSpinner$f;

    iput-object p4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->p:Landroidx/appcompat/widget/ListPopupWindow;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/t;
    ...
    sget v0, Lc/a/j;->Spinner_android_prompt:I

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/e0;->o(I)Ljava/lang/String;

    move-result-object v0

    invoke-interface {p4, v0}, Landroidx/appcompat/widget/AppCompatSpinner$f;->m(Ljava/lang/CharSequence;)V

    :goto_6
    sget p4, Lc/a/j;->Spinner_android_entries:I

    invoke-virtual {v1, p4}, Landroidx/appcompat/widget/e0;->q(I)[Ljava/lang/CharSequence;
...
.method private b(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->n:Landroid/graphics/Rect;

    invoke-virtual {p2, v0}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->n:Landroid/graphics/Rect;
...
.method c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/AppCompatSpinner$f;
    ...
    invoke-interface {v0, v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$f;->f(II)V
    ...
    invoke-interface {v0, v1, v1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->f(II)V
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/AppCompatSpinner$f;
    ...
    invoke-direct {p0, p2, v0}, Landroidx/appcompat/widget/AppCompatSpinner;->b(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->k:Landroidx/appcompat/widget/AppCompatSpinner$f;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:Landroidx/appcompat/widget/t;
