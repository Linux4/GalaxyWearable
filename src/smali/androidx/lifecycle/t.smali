...
# instance fields
.field private final a:Landroidx/lifecycle/t$b;
...
.method public constructor <init>(Landroidx/lifecycle/u;Landroidx/lifecycle/t$b;)V
    ...
    iput-object p2, p0, Landroidx/lifecycle/t;->a:Landroidx/lifecycle/t$b;
...
.method public b(Ljava/lang/String;Ljava/lang/Class;)Landroidx/lifecycle/s;
    ...
    iget-object p1, p0, Landroidx/lifecycle/t;->a:Landroidx/lifecycle/t$b;
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/t$e;->b(Landroidx/lifecycle/s;)V

    :cond_0
    return-object v0

    :cond_1
    iget-object v0, p0, Landroidx/lifecycle/t;->a:Landroidx/lifecycle/t$b;

    instance-of v1, v0, Landroidx/lifecycle/t$c;

    if-eqz v1, :cond_2

    check-cast v0, Landroidx/lifecycle/t$c;

    invoke-virtual {v0, p1, p2}, Landroidx/lifecycle/t$c;->c(Ljava/lang/String;Ljava/lang/Class;)Landroidx/lifecycle/s;
    ...
    :cond_2
    invoke-interface {v0, p2}, Landroidx/lifecycle/t$b;->a(Ljava/lang/Class;)Landroidx/lifecycle/s;
