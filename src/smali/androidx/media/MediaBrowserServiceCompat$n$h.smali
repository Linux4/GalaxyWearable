...
.method constructor <init>(Landroidx/media/MediaBrowserServiceCompat$n;Landroidx/media/MediaBrowserServiceCompat$o;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iput-object p2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->e:Landroidx/media/MediaBrowserServiceCompat$o;

    iput-object p3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->f:Ljava/lang/String;

    iput-object p4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->g:Landroid/os/Bundle;

    iput-object p5, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->h:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    iget-object v0, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->e:Landroidx/media/MediaBrowserServiceCompat$o;
    ...
    iget-object v1, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->f:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->f:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->g:Landroid/os/Bundle;

    iget-object v4, p0, Landroidx/media/MediaBrowserServiceCompat$n$h;->h:Landroid/support/v4/os/ResultReceiver;
